        ...
        <form onSubmit={sendEmail}>
          ...
          <div className="mb-4">
            ...
            <textarea
              ...
              name="message"
            />
            <div className="mb-3 w-10 justify-center items-center">
              <button
                onClick={() => useHistory.push('/sentEmail')}
                className="w-full px-3 py-4 text-white  rounded-md focus:outline-none hover:text-white  hover:bg-black cursor-pointer"
                type="submit"
                value="Send"
              >
                <span className="justify-center items">{'Send Email'}</span>
              </button>
            </div>
          </div>
        </form>
