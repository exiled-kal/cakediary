    ...
    >
      ...
      <div className="m-5 ">
        ...
        <p className="font-serif">
          ...
          <span className="font-sans md:font-serif text-black text-lg animate-bounce italics">
            Sonam Paldon
          </span>{' '}
        ...
        <p>
          ...
          suggestions or ideas if needed and create a cake of your choice. I hope,
        ...
        <div className="mb-10 justify-center items-center rounded-md">
          ...
          <div className="">
            <h1 className="subpixel-antialiased extrabold ">
              It would be most appreciated if you can check out my bakery
              profile and share as much as you can with your loved ones.
            </h1>
