      ...
      <div className="bg-gray-50 flex-grow p-6">
        <form onSubmit={sendEmail}>
          <div className="mb-4">
            ...
            <label className="w-full px-3 py-2 bg-white placeholder-gray-300 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-indigo-100 focus:border-indigo-300">Name</label>
