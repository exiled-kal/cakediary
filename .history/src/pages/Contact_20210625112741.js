...
const Contact = () => {
  ...
  return (
    ...
    <div className="fixed flex flex-col z-50 bottom-[100px] top-0 w-full right-0 h-auto left-0 sm:top-auto sm:right-5 sm:left-auto h-[calc(100%-95px)] w-full sm:w-[350px] overflow-auto min-h-[250px] sm:h-[600px] shadow-2xl justify-center items-center rounded-md">
