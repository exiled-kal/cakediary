  ...
  return (
    <div className="justify-center items-center rounded-md bg-gray-50">
      <div class="flex p-5 flex-col justify-center items-center h-20 bg-indigo-600">
        <h3 class="text-2xl text-white w-60 rounded">How can we help ?</h3>
      </div>
          ...
          <div className="mb-4">
            ...
            <div className="mb-3  rounded-md">
              <button
                ...
                className="w-60 px-3 py-4 text-white  rounded-md focus:outline-none hover:text-black  hover:bg-black cursor-pointer"
                type="submit"
                value="Send"
              >
                <span className="justify-center items-center">Send Email</span>
              </button>
            </div>
          </div>
        </form>
