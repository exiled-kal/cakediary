  ...
  return (
    <div className=" text-white flex h-screen">
      ...
      >
        ...
        <p>
          What you can expect from me is very personal level of service and listen carefully to what you would like to add into your cake, give suggestions/ideas if needed and 
        </p>
      </div>
    </div>
  );
