...
const About = () => {
  ...
  return (
    <motion.div
      className=" text-white h-screen intro"
      ref={(el) => (intro = el)}
    >
      <div
      ...
      >
        <img
          ...
          src="https://scontent-fml2-1.xx.fbcdn.net/v/t1.18169-9/942851_462110357202083_1015497823_n.jpg?_nc_cat=105&ccb=1-3&_nc_sid=cdbe9c&_nc_ohc=nZuudcmb0qgAX9oLvg9&tn=ptwVusIO2fOqrr4n&_nc_ht=scontent-fml2-1.xx&oh=2a79db97805426cbed8e1acc5b582b8b&oe=60D584DD"
          alt="mypics"
        />
      </div>
      <div className="m-5 ">
