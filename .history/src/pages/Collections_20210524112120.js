...
const Collections = () => {
  return (
    ...
    <div className="bg-blue-500 flex flex-wrap w-full max-auto ">
      ...
      <Link
        to="/"
        className="p-4 font-bold rounded-full  hover:text-white transition duration-300 ease-in-out items-center text-lg"
      >
        Tibetan Baker
      </Link>
    </div>
