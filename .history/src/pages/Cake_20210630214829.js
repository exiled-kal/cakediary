    ...
    <div className=" flex m-5 ">
      ...
      >
        <div className="overflow-x-hidden box-border flex w-90">
          <motion.img
            src={image1}
            className=" m-4 transition duration-300 ease-in-out items-center bg-blue-300 rounded-lg underline transform hover:scale-110 motion-reduce:transform-none w-screen height"
