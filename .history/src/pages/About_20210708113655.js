...
const About = () => {
  ...
  return (
    <motion.div
      className=" text-white h-screen intro m-5 bg-gradient-to-r from-green-400 to-blue-500"
      ref={(el) => (intro = el)}
    >
      <div
