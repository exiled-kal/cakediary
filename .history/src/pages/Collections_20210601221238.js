      ...
      <div className="grid grid-cols-3 gap-8 h-full m-8 items-center">
        {cakes.map(({id, data: {name, photoUrl}}) => (
          <div>
            ...
            <h2>lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsumlorem ipsum lorem ipsum lorem ipsum lorem ipsum</h2>
          </div>
        ))}
      </div>
    </div>
