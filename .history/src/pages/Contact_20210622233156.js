      ...
      <div>
        <form onSubmit={sendEmail}>
          <div className="grid grid-cols-1 mt-5 mx-7">
            <input className="py-2 px-3 rounded-lg border-2 border-purple-300 mt-1 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent" type="hidden" name="contact_number" />
