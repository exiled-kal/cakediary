const About = () => {
  return (
    <div className="">
      ...
      <div className="bg-local" style="background-image: url(https://firebasestorage.googleapis.com/v0/b/cake-3ad68.appspot.com/o/PhotoRoom_20210427_173249.jpg?alt=media&token=2ab8f25b-280c-4093-aa2d-63dbba8d6bc8)">
        <p>
