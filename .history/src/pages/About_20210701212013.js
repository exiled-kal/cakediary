...
const About = () => {
  ...
  return (
    ...
    >
      ...
      <div className="m-5 ">
        <h1 className="text-4xl text-white m-6 ">About me</h1>
        <div className="font-serif hover:text-black hover:text-white">
          <p>
            Hello Everyone. My name is{' '}
            <span className=" text-black text-lg animate-bounce italics hover:text-white">
