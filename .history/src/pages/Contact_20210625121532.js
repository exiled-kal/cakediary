        ...
        <form onSubmit={sendEmail}>
          ...
          <div className="mb-4">
            ...
            <textarea
              ...
              className="w-full h-28 mpx-3 py-2 placeholder-white border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-indigo-100 focus:border-indigo-300"
              name="message"
            />
            <div className="mb-3">
              <input
