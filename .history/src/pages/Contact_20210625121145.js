...
const Contact = () => {
  ...
  return (
    ...
    <div className="flex h-screen justify-center items-center rounded-md">
      ...
      <div className="bg-gray-50 flex-grow p-6">
        <form onSubmit={sendEmail}>
          <div className="mb-4">
            ...
            <label className="m-2 rounded-lg text-white">Name</label>
            <input className="rounded-lg" type="text" name="user_name" />
          </div>
          <div className="m-2">
            <label className="m-2 rounded-lg text-white">Email</label>
            <input className="rounded-lg" type="email" name="user_email" />
          </div>
          <div className="mb-4">
            <label className="rounded-lg">Message</label>
            <textarea
              placeholder="Your Message"
              className="w-full h-28 px-3 py-2 placeholder-white border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-indigo-100 focus:border-indigo-300"
              name="message"
            />
            <div className="mb-3">
              <input
