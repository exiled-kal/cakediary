...
const Contact = () => {
  ...
  return (
    ...
    <div className="fixed flex flex-col z-50 bottom-[100px] top-0 w-full right-0 h-auto left-0 sm:top-auto sm:right-5 sm:left-auto h-[calc(100%-95px)] sm:w-[350px] overflow-auto min-h-[250px] sm:h-[600px] shadow-2xl justify-center items-center rounded-md">
      ...
      <div className="bg-gray-50 flex-grow p-6">
        <form onSubmit={sendEmail}>
          ...
          <div className="mb-4">
            ...
            <div className="mb-3">
              <input
                className="w-full px-3 py-4 text-white bg-indigo-500 rounded-md focus:bg-indigo-600 focus:outline-none hover:bg-blue-700 cursor-pointer"
                type="submit"
                value="Send"
              />
            </div>
