    ...
    <div className="justify-center items-center rounded-md bg-gray-50">
      ...
      <div className="bg-gray-500 flex-grow p-2 m-2 ">
        <form onSubmit={sendEmail}>
          <div className="mb-4">
            <label className="m-2 rounded-lg text-white text-sm">Name</label>
            <input className="rounded-lg w-auto" type="text" name="user_name" />
          </div>
          <div className="m-2">
            <label className="m-2 rounded-lg text-white text-sm">Email</label>
            <input
              className="rounded-lg text-base w-auto"
              type="email"
              name="user_email"
            />
          </div>
