  ...
  return (
    <>
      <Carousel className="w-auto">
        <Carousel.Item>
          <img className="w-80" src={image1} alt="First slide" />
        </Carousel.Item>
        <Carousel.Item>
          <img className="w-80" src={image2} alt="Second slide" />
        </Carousel.Item>
        <Carousel.Item>
          <img className="w-80" src={image3} alt="Third slide" />
        </Carousel.Item>
        <Carousel.Item>
          <img className="w-80" src={image4} alt="Third slide" />
        </Carousel.Item>
      </Carousel>
