  ...
  return (
    <div className="bg-blue-300">
      ...
      <div className="h-screen flex flex-col justify-center items-center bg-blue-300">
        ...
        <Link
          to="/collections"
          className="py-6 px-10 bg-blue-100 rounded-full text-3xl hover:bg-black text-blue-300 transition duration-300 ease-in-out flex items-center animate-spin animate-none"
        >
          For more
          <svg
