...
const NavBar = ({toggle}) => {
  return (
    ...
    >
      ...
      <div className="pr-8 md:block hidden bg-pink-500 rounded-full text-3xl hover:bg-pink-300 transition duration-300 ease-in-out flex items-center animate-bounce">
