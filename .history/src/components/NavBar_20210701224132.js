...
const NavBar = ({toggle}) => {
  ...
  return (
    ...
    >
      <NavLink
        to="/about"
        className="p-4 m-4 font-bold transition duration-300 ease-in-out items-center text-lg rounded-lg underline transform hover:scale-110 motion-reduce:transform-none hover:bg-"
      >
