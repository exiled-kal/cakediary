  ...
  return (
    <div className="bg-blue-300">
      ...
      <div className="h-screen flex flex-col justify-center items-center bg-pink-300">
        ...
        <Link
          to="/collections"
          className="py-6 px-10 text-black bg-blue:200 rounded-full text-3xl hover:bg-black text-blue-300 transition duration-300 ease-in-out flex items-center animate-bounce"
        >
          For more
          <svg
